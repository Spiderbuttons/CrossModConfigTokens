...
public partial interface ICrossModCompatibilityToolsAPI
{
    ...
    bool TryRegisterAction(IManifest manifest, string actionId, string? category, Func<string>? description, Action action, Dictionary<string, string>? customFields, object? customData, out string? error);
    ...
    bool TryGetActionsFromModAsDict(IModInfo mod, [NotNullWhen(true)] out IReadOnlyDictionary<string, ICrossModAction>? actions, out string? error);
    ...
    /// <param name="error">The error indicating what went wrong, or <c>null</c> if everything went right.</param>
    /// <returns>A bool indicating whether the Actions were found.</returns>
    bool TryGetActionsFromModAsList(IModInfo mod, [NotNullWhen(true)] out IReadOnlyList<ICrossModAction>? actions, out string? error);
    ...
    /// <param name="error">The error indicating what went wrong, or <c>null</c> if everything went right.</param>
    /// <returns>A bool indicating whether the Actions were found.</returns>
    bool TryGetActionsByCategory(string category, [NotNullWhen(true)] out IReadOnlyList<ICrossModAction>? actions, out string? error);
    ...
    /// <param name="error">The error indicating what went wrong, or <c>null</c> if everything went right.</param>
    /// <returns>A bool indicating whether the Actions were found.</returns>
    bool TryGetActionsAsDict([NotNullWhen(true)] out IReadOnlyDictionary<string, ICrossModAction>? actions, out string? error);
    ...
    /// <returns>A bool indicating whether the Actions were found.</returns>
    bool TryGetActionsAsList([NotNullWhen(true)] out IReadOnlyList<ICrossModAction>? actions, out string? error);
    ...
    /// <param name="error">The error indicating what went wrong, or <c>null</c> if everything went right.</param>  
    /// <returns>A bool indicating whether the Action was invoked successfully.</returns>
    bool TryInvokeActionById(string actionId, out string? error);

...
public partial interface ICrossModCompatibilityToolsAPI
{
    ...
    bool TryGetModEntry(IModInfo mod, [NotNullWhen(true)] out IMod? modInstance, out string? error);
    ...
    bool TryGetContentPack(IModInfo mod, [NotNullWhen(true)] out IContentPack? pack, out string? error);
    ...
    bool TryGetModHelper(IModInfo mod, [NotNullWhen(true)] out IModHelper? helper, out string? error);
    ...
    bool TryGetModAssembly(IModInfo mod, [NotNullWhen(true)] out Assembly? assembly, out string? error);
    ...
    bool TryGetTypeFromMod(IModInfo mod, string typeName, [NotNullWhen(true)] out Type? type, out string? error);
    ...
    bool TryGetMethodFromMod(IModInfo mod, string? typeName, string methodName, [NotNullWhen(true)] out MethodInfo? method, out string? error);
